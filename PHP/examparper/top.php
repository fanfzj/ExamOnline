...
#main{
 ...
 include ("../conn/conn.php");   //连接数据库
   ...
   $use="fanfzj";
?>
<body id="main"> <table width="97%" height="76"  border="1" cellpadding="0"  cellspacing="0" id="top1">
    <tr>
            <th width="330" scope="col">姓名：
        <?php
        ...
        <th width="330" scope="col">专业：
			 ...
			 echo $axyname[0];
			 ?>
        <th width="332" scope="col">学号：
         <?php
			 echo $asno[0];
		 ?>
         <th width="298"  scope="col">考试项目：
         <?php
